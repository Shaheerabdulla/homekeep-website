...
const schema = [
  ...
  },
  {
    ...
    "mainEntity": [
      ...
      { "@type": "Question", "name": "Do you offer same-day AC repair in Doha?", "acceptedAnswer": { "@type": "Answer", "text": "Yes — Homekeep offers same-day and next-day AC repair across Doha. For emergencies, call +974 50002548 or WhatsApp +974 50002548. AMC customers receive priority same-day dispatch." } }
    ]
  }
];
...
const data: AreaPageData = {
  ...
  metaDescription: "AC service, AHU servicing, FCU cleaning, chiller maintenance, and plumbing for villas and apartments across Doha Qatar. Same/next-day response. From QAR 150. Call +974 50002548.",
  ...
  whyPoints: [
    ...
    { title: "Same-Day Emergency Response", desc: "AC emergencies in Doha's summer are urgent. We prioritise emergency callouts and aim to respond the same day. Call +974 50002548 for immediate assistance." },
  ...
  faqs: [
    ...
    { q: "Do you offer same-day AC repair in Doha?", a: "Yes — we offer same-day and next-day AC repair across Doha. For emergency AC failures, call +974 50002548 or WhatsApp +974 50002548. AMC customers receive priority dispatch." },
