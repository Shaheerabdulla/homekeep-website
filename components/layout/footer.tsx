        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex items-center gap-3 mt-6">
              <a href="https://www.facebook.com/people/Homekeep-Improvements/61575275214372/" target="_blank" rel="noreferrer" aria-label="Homekeep Qatar on Facebook" className="h-9 w-9 flex items-center justify-center rounded-full bg-white/10 hover:bg-primary transition-colors">
                <Facebook className="h-4 w-4" />
              </a>
              <a href="https://www.instagram.com/homekeepqatar/" target="_blank" rel="noreferrer" aria-label="Homekeep Qatar on Instagram" className="h-9 w-9 flex items-center justify-center rounded-full bg-white/10 hover:bg-primary transition-colors">
                <Instagram className="h-4 w-4" />
              </a>
              <a href="https://www.linkedin.com/company/homekeep-improvements/" target="_blank" rel="noreferrer" aria-label="Homekeep Qatar on LinkedIn" className="h-9 w-9 flex items-center justify-center rounded-full bg-white/10 hover:bg-primary transition-colors">
                <Linkedin className="h-4 w-4" />
              </a>
              <a href="https://www.tiktok.com/@homekeepqatar" target="_blank" rel="noreferrer" aria-label="Homekeep Qatar on TikTok" className="h-9 w-9 flex items-center justify-center rounded-full bg-white/10 hover:bg-primary transition-colors">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M16.6 5.82s.51.5 0 0A4.278 4.278 0 0 1 15.54 3h-3.09v12.4a2.592 2.592 0 0 1-2.59 2.5c-1.42 0-2.6-1.16-2.6-2.6 0-1.72 1.66-3.01 3.37-2.48V9.66c-3.45-.46-6.47 2.22-6.47 5.64 0 3.33 2.76 5.7 5.69 5.7 3.14 0 5.69-2.55 5.69-5.7V9.01a7.35 7.35 0 0 0 4.3 1.38V7.3s-1.88.09-3.24-1.48z"/></svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-gray-400 text-sm">
              ...
              <li><a href="tel:+97455108965" className="hover:text-primary transition-colors">+974 5510 8965</a></li>
